            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mt-6 bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6">
                    ...
                    <p className="text-yellow-800">
                        Make sure you've added your <code className="bg-yellow-200 px-2 py-1 rounded">GEMINI_API_KEY</code> to a{" "}
                        <code className="bg-yellow-200 px-2 py-1 rounded">.env.local</code> file in the v0 directory.
                    </p>
                </div>
            </div>
        </div>
