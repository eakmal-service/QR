    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
            <div className="max-w-md w-full p-8 border border-white/10 rounded-2xl bg-black/50 backdrop-blur-xl">
                <h2 className="text-3xl font-bold text-white mb-2" style={{ fontFamily: "var(--font-playfair)" }}>Create Account</h2>
                <p className="text-gray-400 mb-8">Join QR.Akmal today</p>
